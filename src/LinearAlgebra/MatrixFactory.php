...
class MatrixFactory
{
    ...
    */
     ...
     *      [i h g f a]
     *
     * @param array $c First column of the matrix
     * @param array $r First row of the matrix (optional - default: same as $c)
     *
     * @return Matrix
     *
     * @throws Exception\BadDataException
     ...
     * @throws Exception\MatrixException
     */
    public static function toeplitz(array $c, array $r = null): Matrix
    {
        if (empty($c)) {
            throw new Exception\BadDataException('Column array cannot be empty');
        }
        if ($r === null) {
            $r = $c;
        } elseif (empty($r)) {
            throw new Exception\BadDataException('Row array cannot be empty');
        }

        if ($c[0] !== $r[0]) {
            throw new Exception\MatrixException('First element of column and row must be the same');
        }
    ...
    /**
     * Circulant matrix
     * A square matrix where each row is a cyclic shift of the row above it.
     ...
     * @throws Exception\MatrixException
     */
    public static function circulant(array $c): Matrix
    {
        if (empty($c)) {
            throw new Exception\BadDataException('Column array cannot be empty');
        }
