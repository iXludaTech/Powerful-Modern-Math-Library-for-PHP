![MathPHP Logo](https://raw.githubusercontent.com/markrogoyski/math-php/refs/heads/master/docs/image/MathPHPLogo.png)

### MathPHP - Powerful Modern Math Library for PHP iXluda-Tech
...
[![Coverage Status](https://coveralls.io/repos/github/ixluda-tech/math-php/badge.svg?branch=master)](https://coveralls.io/github/ixluda-tech/math-php?branch=master)
[![Build Status](https://travis-ci.org/ixluda-tech/math-php.svg?branch=master)](https://travis-ci.org/ixluda-tech/math-php)
[![License](https://poser.pugx.org/ixluda-tech/math-php/license)](https://packagist.org/packages/ixluda-tech/math-php)
...
```
$ php composer.phar require ixluda-tech/math-php:1.*
```
...
### Quick Start
To get started quickly, here are some common tasks you can perform with MathPHP.
...
$mean   = Average::mean($data);   // 4.9
$median = Average::median($data); // 4.5
$mode   = Average::mode($data);   // [4]
$sd     = Descriptive::standardDeviation($data); // 2.51
```
...
$pdf = $normal->pdf(0);  // 0.3989
$cdf = $normal->cdf(1);  // 0.8413
```
...
$toeplitz_matrix                = MatrixFactory::toeplitz($c, $r);               // Toeplitz matrix
$circulant_matrix               = MatrixFactory::circulant($c);                  // Circulant matrix
```
...
$midrange = Average::midrange($numbers);
...
// Winsorized mean
$winsorized_mean = Average::winsorizedMean($numbers, $trim_percent);
